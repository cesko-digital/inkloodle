...
class block_edmo_instructor_slider_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('select', 'config_slidernumber', get_string('config_items', 'theme_edmo'), $range);
        $mform->setDefault('config_slidernumber', 3);

        for($i = 1; $i <= $itemNumber; $i++) {
            $mform->addElement('header', 'config_edmo_item' . $i , get_string('config_item', 'theme_edmo') . $i);

            $mform->addElement('text', 'config_instructor_name' . $i, get_string('config_instructor_name', 'block_edmo_instructor_slider', $i));
            $mform->setDefault('config_instructor_name' . $i, 'William James');
            $mform->setType('config_instructor_name' . $i, PARAM_TEXT);

            $mform->addElement('text', 'config_instructor_designation' . $i, get_string('config_instructor_designation', 'block_edmo_instructor_slider', $i));
            $mform->setDefault('config_instructor_designation' . $i, 'William James');
            $mform->setType('config_instructor_designation' . $i, PARAM_TEXT);

            $mform->addElement('text', 'config_instructor_img' . $i, get_string('config_instructor_img', 'block_edmo_instructor_slider', $i));
            ...
            $mform->addElement('text', 'config_social_1_link' . $i, get_string('config_social_link', 'block_edmo_instructor_slider', $i));
            ...
            $mform->addElement('text', 'config_social_2_link' . $i, get_string('config_social_link', 'block_edmo_instructor_slider', $i));
            ...
            $mform->addElement('text', 'config_social_3_link' . $i, get_string('config_social_link', 'block_edmo_instructor_slider', $i));
            ...
            $mform->addElement('text', 'config_social_4_link' . $i, get_string('config_social_link', 'block_edmo_instructor_slider', $i));
            ...
            $mform->addElement('text', 'config_social_5_link' . $i, get_string('config_social_link', 'block_edmo_instructor_slider', $i));
