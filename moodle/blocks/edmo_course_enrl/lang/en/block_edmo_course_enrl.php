<?php
$string['pluginname'] = '[Edmo] Course Enrolment Custom';
$string['edmo_course_enrl'] = '[Edmo] Course Enrolment Custom';
$string['edmo_course_enrl:addinstance'] = 'Add a new course Enrolment Custom block';
$string['edmo_course_enrl:myaddinstance'] = 'Course Enrolment Custom block';
